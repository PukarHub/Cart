    ...
    const PaymentComponent = () => (
        <div id="payment">
            ...
            <a href="https://esewa.com.np/#/home">
                <button>
                    <img id="esewa" src={Esewa} alt="Loading Esewa...." />
                </button>
            </a>
            <a href="https://www.paypal.com/np/home">
                <button>
                    <img id="paypal" src={Paypal} alt="Loading Paypal..." />{' '}
                </button>
            </a>{' '}
            <br /> <br />
            <form>
                ...
                <button id="backbtn" onClick={toggleDetail}>
                    Back to Detail
                </button>
            </form>
        </div>
